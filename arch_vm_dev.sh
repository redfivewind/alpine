...
TOOLS="alsa-plugins alsa-utils chkrootkit choosenim chromium cmake gimp git go keepass libreoffice librewolf-bin magic-wormhole make mingw-w64 miniconda3 monodevelop-bin nasm nim onboard pinta pulseaudio python3 python3-pip python3-virtualenv python3-wheel rustup secure-delete virtualbox-guest-utils vlc vscodium-bin"
