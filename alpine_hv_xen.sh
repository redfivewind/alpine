...
echo "options=com1=115200,8n1,0xe000,0 console=com1,vga flask=disabled guest_loglvl=all iommu=debug,force,verbose loglvl=all noreboot sync_console vga=current,keep" | doas tee -a $TMP_XEN_CFG
