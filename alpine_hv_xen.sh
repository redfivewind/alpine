...
echo "options=com1=115200,8n1 conring_size=2097152 console=com1,vga flask=disabled guest_loglvl=all iommu=no-igfx loglvl=all noreboot vga=current" | doas tee -a $TMP_XEN_CFG
