...
# Install Gnome & GDM
sudo pacman --disable-download-timeout -noconfirm -Sy gdm gnome-session gnome-shell-extensions gnome-tweaks

# Install Gnome core applications
sudo pacman --disable-download-timeout -noconfirm -Sy baobab eog evince gnome-calculator gnome-clocks gnome-console gnome-control-center gnome-disk-utility gnome-logs gnome-system-monitor gnome-text-editor nautilus
